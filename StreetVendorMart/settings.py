"""
Django settings for StreetVendorMart project.
...
SECRET_KEY = 'wzn*ckyyczvj#-hbfif)5%1(j*oq$$-^&ifgshxga%k)b1hu16'
...
WSGI_APPLICATION = 'StreetVendorMart.wsgi.application'
